...
//        footLoadingLayout = (LinearLayout) footView.findV iewById(R.id.loading_layout);
...
//                                pb.setVisibility(View.INVISIBLE);
                                ...
                                L.e(TAG,"chatRoomList="+chatRoomList.toString());
...
//                            footLoadingLayout.setVisibility(View.GONE);
    ...
    public static List<LiveRoom> getLiveRoomList(List<EMChatRoom> chatRooms) {
        ...
        L.e(TAG,"LiveListFragment.chatRooms="+chatRooms);
    ...
    private void setPullUpListenre() {
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState== AbsListView.OnScrollListener.SCROLL_STATE_IDLE) {
                        int lasPos = gm.findFirstVisibleItemPosition();
