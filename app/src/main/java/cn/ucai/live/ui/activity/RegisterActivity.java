...
//                }
    ...
    private void registerAppSever() {
        //注册自己的服务器的账号
        NetDao.register(RegisterActivity.this, username, usernick, pwd, new OnCompleteListener<String>() {
            @Override
    ...
    private void unRegisterAppSever() {
        NetDao.unRegister(RegisterActivity.this, username, new OnCompleteListener<String>() {
            @Override
